		<article id="stirling" class="view container">
			<div class="row project-row">

				<div class="item col-sm-8">
					 <a class="project-feature-img" href="http://www.stirlinghonda.com/" target="_blank">
					 	<img id="img-stirling" class="int-img" src="images/stirling.jpg" alt="Siamkas Car Company" />
					 </a>
				</div>

				<div class="item col-sm-4 project">
					<h1 class="project-title">STIRLING HONDA</h1>
					<p class="project-role">PROJECT MANAGEMENT</p>
					<div class="project details">
						...
						<div class="project-buttons">
							<a class="go-to-site page-button transitioner" href="http://www.stirlinghonda.com" target="_blank">VIEW WEBSITE</a>
