		<article id="couve" class="view container">
			<div class="row project-row">

				<div class="item col-sm-8">
					 <a class="project-feature-img" href="http://www.carsinthecouve.com/" target="_blank">
					 	<img id="img-couve" class="int-img" src="images/couve.jpg" alt="Siamkas Car Company" />
					 </a>
				</div>

				<div class="item col-sm-4 project">
					<h1 class="project-title">CARS IN THE COUVE</h1>
					...
					<div class="project details">
						...
						<div class="project-buttons">
							<a class="go-to-site page-button transitioner" href="http://www.carsinthecouve.com" target="_blank">VIEW WEBSITE</a>
