		<article id="canby" class="view container">
			<div class="row project-row">

				<div class="item col-sm-8">
					 <a class="project-feature-img" href="http://www.canbyford.com/" target="_blank">
					 	<img id="img-canby" class="int-img" src="images/canby.jpg" alt="Siamkas Car Company" />
					 </a>
				</div>

				<div class="item col-sm-4 project">
					<h1 class="project-title">CANBY FORD</h1>
