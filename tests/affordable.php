		<article id="affordable" class="view container">
			<div class="row project-row">

				<div class="item col-sm-8">
					 <a class="project-feature-img" href="http://www.affordableautowholesale.com/" target="_blank">
					 	<img id="img-affordable" class="int-img" src="images/affordable.jpg" alt="Siamkas Car Company" />
					 </a>
				</div>

				<div class="item col-sm-4 project">
					<h1 class="project-title">AFFORDABLE AUTO</h1>
					...
					<div class="project details">
						...
						<a class="go-to-site" href="http://www.affordableautowholesale.com/" target="_blank">VIEW WEBSITE</a>
