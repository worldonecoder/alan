		<article id="siamaks" class="view container">
			<div class="row project-row">

				<div class="item col-sm-8">
					 <a class="project-feature-img" href="http://www.siamaks.com/" target="_blank">
					 	<img id="img-siamaks" class="int-img" src="images/siamaks.jpg" alt="Siamkas Car Company" />
					 </a>
				</div>
				...
				<div class="item col-sm-4 project">
					...
					<div class="project details">
						...
						<div class="project-buttons">
							<a class="go-to-site page-button transitioner" href="http://www.siamaks.com" target="_blank">VIEW WEBSITE</a>
