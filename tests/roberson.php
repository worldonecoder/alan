		<article id="roberson" class="view container">
			<div class="row project-row">

				<div class="item col-sm-8">
					 <a class="project-feature-img" href="http://www.robersonrv.net/" target="_blank">
					 	<img id="img-roberson" class="int-img" src="images/roberson.jpg" alt="Siamkas Car Company" />
					 </a>
				</div>

				<div class="item col-sm-4 project">
					<h1 class="project-title">ROBERSON RV</h1>
					...
					<div class="project details">
						...
						<div class="project-buttons">
							<a class="go-to-site page-button transitioner" href="http://www.robersonrv.net" target="_blank">VIEW WEBSITE</a>
